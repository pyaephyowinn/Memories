        ...
        {!showTwoFactor ? (
          ...
          <Card>
              ...
              <Tabs defaultValue="app" className="w-full">
                ...
                <TabsContent value="app" className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Open your authenticator app and enter the 6-digit code for Acme Real Estate.
                  </p>
                </TabsContent>
                ...
                <TabsContent value="sms" className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="sms-code" placeholder="Enter 6-digit code" maxLength={6} />
                  </div>
                  <p className="text-xs text-muted-foreground">
                    We've sent a verification code to your registered phone number. It will expire in 10 minutes.
                  </p>
                </TabsContent>
              </Tabs>
            </CardContent>
            <CardFooter className="flex flex-col space-y-4">
              ...
              <Button variant="outline" className="w-full" onClick={() => setShowTwoFactor(false)}>
                Back to Login
              </Button>
            </CardFooter>
          </Card>
